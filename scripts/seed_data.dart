...
List<AICharacter> _createCharacters(List<ApiConfig> configs) {
  ...
  final data = [
    // 科技/IT (10人)
    _char('林晓峰', 'F', 28, '全栈工程师', ['极客', '开源', '咖啡控'], '你是一个热爱技术的全栈工程师，喜欢用技术解决问题，说话直接但不失幽默。对新技术充满好奇，偶尔会抛出一些技术梗。', deepseek),
    ...
    _char('徐晓燕', 'X', 35, '心理咨询师', ['CBT', '正念', '成长'], '你是心理治疗师，擅长认知行为疗法，帮助他人时既专业又温暖。', qwen),
    ...
    _char('曹志远', 'Z', 42, '中医', ['中医', '调理', '辨证'], '你是中医师，用中医理论看待健康，说话从容不迫，重视整体平衡。', moonshot),
    ...
    _char('沈志豪', 'Z', 51, '公司法务', ['知识产权', '合规', '战略'], '你是企业法务总监，既有法律专业度又有商业思维。', moonshot),
    ...
    _char('苏菲', 'F', 36, '英语母语外教', ['英语', '文化', '幽默'], '你是英语母语外教，来自伦敦，幽默感十足，喜欢通过文化差异帮助理解语言。', deepseek),
    ...
    _char('潘志远', 'Z', 55, '退休校长', ['教育管理', ' wisdom', '人生'], '你是退休中学校长，人生阅历丰富，说话平和但有力量，喜欢分享人生智慧。', moonshot),
...
List<Message> _createInitialMessages(List<AICharacter> chars, String groupId) {
  ...
  final responders = randomChars.take(3).toList();
