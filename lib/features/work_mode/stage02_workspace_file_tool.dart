    ...
    return _withMutationLock(
      ...
      () async {
        ...
        final response = <String, dynamic>{
          ...
          if (result.contentChanged != null) 'changed': result.contentChanged,
          if (result.beforeSha256 != null) 'beforeSha256': result.beforeSha256,
          if (result.afterSha256 != null) 'afterSha256': result.afterSha256,
